...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        ...
        if char_class == 'warrior':
            print("""Воитель — дерзкий воин ближн
                  его боя. Сильный, выносливый и отважный.""")
        if char_class == 'mage':
